...
- (UIImage *)pickerView:(AKPickerView *)pickerView selectedImageForItem:(NSInteger)item;
@end
...
- (void)pickerView:(AKPickerView *)pickerView configureImageView:(UIImageView * const)imageView forItem:(NSInteger)item;
@end
